...
function Desktop({
  ...
  const cell7Populator = () => {
    if (customizationOptions[2] === 'ducky')
      return <Ducky duckyVisual={duckyVisual} />;
  ...
  const cell9Populator = () => {
    if (customizationOptions[3] === 'ducky')
      return <Ducky duckyVisual={duckyVisual} />;
